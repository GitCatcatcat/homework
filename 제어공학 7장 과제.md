...
$ \% OS = e^{-\pi\zeta/\sqrt{1-\zeta^2}}\times100=3.84\%$
...
$L'(s)=G_c(s) G_p(s)=\frac{z(s)}{p(s)}$  
>(1)  
$p(s)=0, s = 0, -7.5, -10, \; n = 4$  
$z(s)=0, s = -5.56 \pm j0.047\; m = 2$  
(2)  
$\sigma_A = \frac{\Sigma(poles)-\Sigma(zeros)}{n-m} = -3.19$  
$\phi_A = \frac{2k+1}{n-m} \cdot 180 = \frac{2k+1}{2} \cdot 180 = 90^\circ, 270^\circ$  
(3)  
$\theta_1+\theta_2+\theta_3=180+360k$  
$\theta_1=180$  
