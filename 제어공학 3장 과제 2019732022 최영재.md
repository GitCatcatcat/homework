...
(c)  
$\therefore \dot{\mathbf{x}}(t)=\begin{bmatrix} 0&1 \\ -\frac{k}{M}&-\frac{b}{M} \end{bmatrix} \mathbf{x}(t)+\begin{bmatrix} 0 \\ \frac{1}{M} \end{bmatrix} F(t)$  
...
48&44&s+12
\end{bmatrix}$  
$\Phi(s)=[s\mathbf{I}-\mathbf{A}]^{-1}=\frac{1}{s^3 + 12s^2 + 44s + 48} \begin{bmatrix}
s^2 + 12s + 44&s + 12&1 \\
-48&s(s + 12)&s \\
-48s&-4(11s + 12)&s^2
\end{bmatrix}$  
...
$X(s)=[s\mathbf{I}-\mathbf{A}]^{-1}X(0)+[s\mathbf{I}-\mathbf{A}]^{-1}BU(s)$  
$Y(s)=CX(s)+DU(s)$  
$Y(s)=[C[s\mathbf{I}-\mathbf{A}]^{-1}B+D]U(s)$  

$G(s)=\frac{Y(s)}{U(s)}=C[s\mathbf{I}-\mathbf{A}]^{-1}B$  
